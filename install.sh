...
cat > $HOME/.zshrc <<- EOM
# zshrc $USERNAME@$HOST (generated by Miaoou/conf/install.sh)
...
$(cd $HOME/neovim && make CMAKE_EXTRA_FLAGS="-DCMAKE_INSTALL_PREFIX=$LOCAL_DIR -DCMAKE_BUILD_TYPE=Release" -j$NB_CPU && make install)
